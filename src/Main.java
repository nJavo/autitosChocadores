public class Main {
    public static void main(String[] args) {
        ...
        // tablero.matriz[0][0] = auto1.toString();
        // tablero.matriz[0][2] = auto2.toString();
        // tablero.matriz[1][1] = auto3.toString();
        // tablero.matriz[1][3] = auto4.toString();
        // tablero.matriz[2][1] = auto5.toString();
        // tablero.matriz[3][0] = auto6.toString();
        // tablero.matriz[3][3] = auto7.toString();
        // tablero.matriz[4][3] = auto8.toString();
